...
export class App extends Component {
    ...
    // When component is already mount
    // Init parts we need inside our component
    async componentDidMount() {
        this.web3 = await getWeb3();
        this.toEther = converter(this.web3);

        // Create an instance of the companyRegistration calling companyRegistration.js
        // Sending Metamask provider
        ...
        // Subscribe to event formalityAccomplished of the companyRegistration contract
        ...
        formalityAccomplished.watch(function (err, result) {
            if(this.state.customerFormalities.length===6){
                // Company data must be obtained from the web platform by the companyId 
                // this.validateCompanyRegistration(1, this.state.account);
        ...
        // Subscribe to event update to reload automatically the web page
    ...
    // Every time the React needs renderize the component because something has change the render is called
    render() {
        return <React.Fragment>

            <div className="jumbotron">
                <h5 className="display-4">Complete sus trámites aquí!!!</h5>
            </div>
            ...
            <div className="row">
                ...
                <div className="col-sm">
                    <Panel title="Trámites Realizados"> {this.state.customerFormalities.map((formality, i) => {
